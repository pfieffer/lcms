                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<?php
								$query = mysql_query("select * from student where id = '$session_id'")or die(mysql_error());
								...
								?>								
								    ...
								    <form  method="post" id="change_password" class="form-horizontal">
										<div class="control-group">
											...
											<div class="controls">
											<input type="hidden" id="password" name="password" value="<?php echo $row['pass']; ?>"  placeholder="Current Password">
